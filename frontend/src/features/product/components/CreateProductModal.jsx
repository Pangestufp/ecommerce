...
export default function CreateProductModal({ onSubmit, onClose, loading, types, generatePresignedURLs, uploadToPresignedURL }) {
  ...
  // imageItems: [{ id: string, file: File, previewURL: string, objectName: string, uploading: bool }]
  ...
  const handleSubmit = async (e) => {
    ...
    await onSubmit(form, imageItems);
  };

  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
      <div className="bg-white rounded-xl p-6 w-[480px] max-h-[90vh] overflow-y-auto shadow-lg">
        <h2 className="text-base font-semibold text-gray-800 mb-4">Buat Produk</h2>
