...
export default function UpdateTypeModal({ onSubmit, onClose, loading, data }) {
const [form, setForm] = useState({
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    await onSubmit(data.type_id, form)
  }

  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
      <div className="bg-white rounded-xl p-6 w-[360px] shadow-lg">
        <h2 className="text-base font-semibold text-gray-800 mb-4">Update Tipe</h2>
