...
type Config struct {
	...
	MidtransProduction bool   `mapstructure:"MIDTRANS_PRODUCTION"`
	SandBoxSnapURL     string `mapstructure:"SANDBOXSNAPURL"`
	ProductionSnapURL  string `mapstructure:"PRODUCTIONSNAPURL"`
	ENVPro             bool   `mapstructure:"ENV_PRO"`
}
...
func LoadConfig() {
	...
	// viper.BindEnv("RAJAONGKIR_API_KEY")
	// viper.BindEnv("RAJAONGKIR_URL")
	// viper.BindEnv("MERCHANT_ID")
	// viper.BindEnv("CLIENT_KEY")
	// viper.BindEnv("SERVER_KEY")
